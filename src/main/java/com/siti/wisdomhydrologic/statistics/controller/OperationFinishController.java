...
public class OperationFinishController {
    ...
    public Map<String, Object> getAll(Integer dateType, Integer year, Integer quarter, String month) {
        ...
        try {
            ...
            List<OperationFinish> returnList = (List<OperationFinish>)CaffeineUtil.build()
                    .getValues("returnList"+","+dateType+","+year+","+quarter+","+month,(x)->{
                return getOpertionFinish(year,list);
            });
    ...
    List<OperationFinish> getOpertionFinish(Integer year,List<String> list){
