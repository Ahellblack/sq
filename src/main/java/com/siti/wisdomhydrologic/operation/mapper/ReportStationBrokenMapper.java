...
public interface ReportStationBrokenMapper extends Mapper<ReportStationBroken>{
    ...
    @Insert("INSERT INTO `report_manage_application_broken`( `station_code`, `station_name`, `broken_happen_time`, `broken_situation`, `broken_resolve_create_time`, `resolve_method`, `resolve_user_ids`, `remark`, `create_by`, `manage_org_id`, `manage_org_name`, `broken_resolve_time`, `broken_response_time`, `create_time`) " +
            "VALUES (#{Broken.stationCode}, #{Broken.stationName}, #{Broken.brokenHappenTime}, #{Broken.brokenSituation},#{Broken.brokenResolveCreateTime}, #{Broken.resolveMethod}, #{Broken.resolveUserIds}, '#{Broken.remark}, #{Broken.createBy}, #{Broken.manageOrgId}, #{Broken.manageOrgName}, #{Broken.brokenResolveTime}, #{Broken.brokenResponseTime}, #{Broken.createTime})" )
    ...
    int updateData(ReportStationBroken reportStationBroken);
}
