...
/**
 * Created by zyw on 2019/11/12.
 */
public class WorkBookUtils {

    public static String download(HttpServletResponse response, Workbook workbook,String excelName) throws UnsupportedEncodingException {
        // 判断数据
        if (workbook == null) {
            return "fail";
        }
