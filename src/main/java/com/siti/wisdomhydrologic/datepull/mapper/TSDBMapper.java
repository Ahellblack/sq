...
public interface TSDBMapper {
    ...
    @Insert("<script>INSERT INTO `history_5min_sensor_data_2001_2017` " +
            ...
            "(#{item.SENID},#{item.sensorDataTime},#{item.V0},#{item.V1},#{item.V2},#{item.V3},#{item.V4},#{item.V5},#{item.V6},#{item.V7},#{item.V8},#{item.V9},#{item.V10},#{item.V11}," +
