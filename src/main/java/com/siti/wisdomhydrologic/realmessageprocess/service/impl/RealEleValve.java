...
public  class RealEleValve implements Valve<RealVo,ELEEntity,AbnormalDetailEntity>,ApplicationContextAware {
    ...
    public void beforeProcess(List<RealVo> realList) {
        ...
        Map<Integer, RealVo> map = realList.stream()
                .filter(
                        e -> ((e.getSenId() + "").substring(5)).equals(ConstantConfig.ES)
