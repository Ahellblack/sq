 ...
 * @data ${DATA}-9:54
 */
public class TSDBWSValve implements Valve<TSDBVo, WSEntity, AbnormalDetailEntity>, ApplicationContextAware {
    ...
    @Override
    public void doProcess(Map<Integer, TSDBVo> mapval, Map<Integer, WSEntity> configMap) {
                    ...
                    IntStream.range(0, 13 - limit).forEach(j -> {
                        ...
                        if (flag[0] == limit) {
                            exceptionContainer[0].add(new AbnormalDetailEntity.builer()
                                    ...
                                    .dateError(DataError.WS_INTER.getErrorCode())
                                    .build());
                        }
                    });
                }else{
                        ...
                        if (timelimit[0] > config.getDuration() / 5) {
                            exceptionContainer[0].add(new AbnormalDetailEntity.builer()
                                    .date(LocalDateUtil
                                            ...
                                            .format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")))
                                    .sensorCode(vo.getSENID())
                                    .dateError(DataError.WS_DURA.getErrorCode())
                                    .build());
                        }
                    } else {
                        doubles[0] = arrayV[k];
