...
public class RainfallEntity {
    ...
    String nearbySendorCode;//附近3个传感器
    ...
    public String getNearbySendorCode() {
        return nearbySendorCode;
    }

    public void setNearbySendorCode(String nearbySendorCode) {
        this.nearbySendorCode = nearbySendorCode;
    }
